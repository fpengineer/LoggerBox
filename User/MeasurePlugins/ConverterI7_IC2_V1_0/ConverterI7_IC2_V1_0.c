/*****************************************************************************************************
    ...
    Overview: Plugin ConverterI7 - IC2 - V1.0
...
#include "ConverterI7_IC2_V1_0\types.h"
#include "ConverterI7_IC2_V1_0\defs.h"
...
void ConverterI7_IC2_V1_0( PluginResult_t *pluginResult, PluginCommand_t pluginCommand, int32_t *tactLength_ms )
{
    ...
    switch ( pluginCommand )
    {
        case CMD_PLUGIN_RUN:
        {
            ...
            HwAPI_Terminal_SendMessage( "ConverterI7_IC2_V1_0 - Run\n" );
#endif
            /* Read plugin config file */
            HwAPI_Terminal_SendMessage( "ConverterI7_IC2_V1_0 - Start reading of measure plan file\n" );
            *pluginResult = GetConfigData( &cfgMeasurePlan, &cfgMeasureEnable, &cfgDatafileSettings );
            if ( !pluginResult->error )
            {
                ...
                if ( cfgDatafileSettings.enableDatafile )
                {
                    ...
                    stringsCounter = 8;
                    HwAPI_Terminal_SendMessage( "ConverterI7_IC2_V1_0 - measure data file created\n" );
        ...
        {
#ifdef PLUGINS_DEBUG_INFO
            HwAPI_Terminal_SendMessage( "ConverterI7_IC2_V1_0 - Stop\n" );
#endif
            /* Clear all sources */
            HwAPI_VoltageSource_ClearAll();
        ...
        {
#ifdef PLUGINS_DEBUG_INFO
            HwAPI_Terminal_SendMessage( "ConverterI7_IC2_V1_0 - Tact\n" );
#endif
        ...
        {
#ifdef PLUGINS_DEBUG_INFO
            HwAPI_Terminal_SendMessage( "ConverterI7_IC2_V1_0 - Error\n" );
#endif
        ...
        {
#ifdef PLUGINS_DEBUG_INFO
            HwAPI_Terminal_SendMessage( "ConverterI7_IC2_V1_0 - Idle\n" );
#endif
                                             ...
                                             CfgDatafileSettings_t *cfgDatafileSettings )
{
    ...
    snprintf( measureDataFilename, sizeFilename, "measure/"PLUGIN_4_NAME"/%s_%s.csv", cfgDatafileSettings->prefixDatafileName, pluginsTempString );
