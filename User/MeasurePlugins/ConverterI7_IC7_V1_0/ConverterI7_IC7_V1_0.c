/*****************************************************************************************************
    ...
    Overview: Plugin ConverterI7 - IC7 - V1.0
...
#include "ConverterI7_IC7_V1_0\types.h"
#include "ConverterI7_IC7_V1_0\defs.h"
...
void ConverterI7_IC7_V1_0( PluginResult_t *pluginResult, PluginCommand_t pluginCommand, int32_t *tactLength_ms )
{
    ...
    switch ( pluginCommand )
    {
        case CMD_PLUGIN_RUN:
        {
            ...
            HwAPI_Terminal_SendMessage( "ConverterI7_IC7_V1_0 - Run\n" );
#endif
            /* Read plugin config file */
            HwAPI_Terminal_SendMessage( "ConverterI7_IC7_V1_0 - Start reading of measure plan file\n" );
            *pluginResult = GetConfigData( &cfgMeasurePlan, &cfgMeasureEnable, &cfgDatafileSettings );
            if ( !pluginResult->error )
            {
                ...
                if ( cfgDatafileSettings.enableDatafile )
                {
                    ...
                    stringsCounter = 8;
                    HwAPI_Terminal_SendMessage( "ConverterI7_IC7_V1_0 - measure data file created\n" );
                }
        ...
        {
#ifdef PLUGINS_DEBUG_INFO
            HwAPI_Terminal_SendMessage( "ConverterI7_IC7_V1_0 - Stop\n" );
#endif
            /* Clear all sources */
            HwAPI_VoltageSource_ClearAll();
        ...
        {
#ifdef PLUGINS_DEBUG_INFO
            HwAPI_Terminal_SendMessage( "ConverterI7_IC7_V1_0 - Tact\n" );
#endif
        ...
        {
#ifdef PLUGINS_DEBUG_INFO
            HwAPI_Terminal_SendMessage( "ConverterI7_IC7_V1_0 - Error\n" );
#endif
        ...
        {
#ifdef PLUGINS_DEBUG_INFO
            HwAPI_Terminal_SendMessage( "ConverterI7_IC7_V1_0 - Idle\n" );
#endif
                                     ...
                                     CfgDatafileSettings_t *cfgDatafileSettings )
{
    ...
    snprintf( measurePlanFilename, GetSizeof_measurePlanFilename(), "MeasurePlan_"PLUGIN_9_NAME".ini" );
         ...
         FATFS_OK != HwAPI_FatFs_INI_GetKeyString( "DatafileSettings", "Delimiter", measurePlanFilename, cfgDatafileSettings->delimiter, MEASURE_PLAN_FILE ) )
    {
        ...
        HwAPI_Terminal_SendMessage( "Measure plan file of the plugin "PLUGIN_9_NAME" read - Error.\n" );
        pluginResult.error = 1;
        pluginResult.errorCode = PLG_ERR_READ_MEASURE_PLAN_FILE;
        snprintf( pluginResult.message, sizeof( pluginResult.message ), "Plugin "PLUGIN_9_NAME". Error comes during reading of measure plan file.\n" );
        return pluginResult;
    }
         
    /* Send readed values to terminal */     
    HwAPI_Terminal_SendMessage( "Measure plan file of the plugin "PLUGIN_9_NAME" read - Success.\n" );
                                             ...
                                             CfgDatafileSettings_t *cfgDatafileSettings )
{
    ...
    snprintf( measureDataFilename, sizeFilename, "measure/"PLUGIN_9_NAME"/%s_%s.csv", cfgDatafileSettings->prefixDatafileName, pluginsTempString );
