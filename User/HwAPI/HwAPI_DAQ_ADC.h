...
#define SRC1_CALIBRATION_SLOPE		1.0026f
#define SRC1_CALIBRATION_OFFSET		0.02f

#define SRC2_CALIBRATION_SLOPE		1.0022f
#define SRC2_CALIBRATION_OFFSET		0.018f

#define SRC3_CALIBRATION_SLOPE		1.0008f
#define SRC3_CALIBRATION_OFFSET		-0.003f

#define SRC4_CALIBRATION_SLOPE		1.001f
#define SRC4_CALIBRATION_OFFSET		0.003f

#define SRC5_CALIBRATION_SLOPE		1.0014f
#define SRC5_CALIBRATION_OFFSET		0.035f

#define SRC6_CALIBRATION_SLOPE		1.0016f
#define SRC6_CALIBRATION_OFFSET		0.045f

#define SRC7_CALIBRATION_SLOPE		1.0026f
#define SRC7_CALIBRATION_OFFSET		0.04f

#define SRC8_CALIBRATION_SLOPE		1.0f
#define SRC8_CALIBRATION_OFFSET		0.006f
