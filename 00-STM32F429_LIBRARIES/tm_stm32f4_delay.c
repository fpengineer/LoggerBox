...
void TM_DELAY_INT_InitTIM(void) {
	...
	TM_TIMER_PROPERTIES_GenerateDataForWorkingFrequency(&TIM_Data, 100000);
	...
	TIM_TimeBaseStruct.TIM_Prescaler = 168/2;//SystemCoreClock / (100000 * (SystemCoreClock / TIM_Data.TimerFrequency)) - 1; /* With prescaler for 1 microsecond tick */
